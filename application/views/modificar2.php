    ...
    <section id="main">
        ...
        <form action="" method="POST">
            <?php foreach ($mod as $fila){ ?>
                ...
                <div class="input-field" >
                    <input type="text" name="imagen_perfil" value="<?=$fila->imagen_perfil?>"style="margin: 2px 2px 2px 2px">
        ...
        <a class="btn blue" href="<?php echo base_url()?>Profesores" style="margin: 2px 2px 2px 2px">volver</a>
        </div>

...
<div class="navbar-fixed z-depth-4" >
    ...
    <section id="main">
        ...
        <div>
            ...
            <h2 class="blue-text hide-on-med-and-down" style="padding:5px 20px">Administrar estudiantes</h2>
                <h1 class="orange-text hide-on-large-only center">Admin. estudiantes</h1>
                <table borde="1" class="striped">
                <thead>
                <tr class="blue-text">
                    <th>Id</th>
                    <th>Nombre</th>
            ...
            <tr>
                <form action="<?php echo base_url()?>Estudiantes/add" method="post">
                    <td></td>
                    <td>
                    ...
                    <td>
                        <div class="input-field" >
                            <input type="number" name="genero" id="genero" required>
...
?>
    <tr>
        ...
        <td>
            <a class="btn blue" style="margin-top: 2px; width:100%;" href="<?php echo base_url()?>Estudiantes/mod/<?=$fila->id_estudiante;?>">Modificar</a>
            <a class="btn blue" style="margin-top: 2px; width:100%;" href="<?php echo base_url()?>Estudiantes/eliminar/<?=$fila->id_estudiante;?>">eliminar</a>
        </td>
    </tr>
<?php
